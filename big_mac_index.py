...
def main():
    ...
    st.subheader("Interactive Big Mac Index Dashboard")
    ...
    fig1.update_layout(yaxis={'categoryorder':'total ascending'}, xaxis_title='Index (over/undervaluation)', showlegend=False, plot_bgcolor="#131b4d")
